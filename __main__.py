...
if __name__ == "__main__":
  ...
  if profile_state != arch.ProfileState.ARCHIVE:
    ...
    # )
    # results_compilation.reconstruct(archive, number_of_samples = 100 , metric = "support")
    ...
    # #   "20220729T121955" # Support
    # # )
    # results_compilation.cross_validate(archive, number_of_folds = 5, metric = "support")

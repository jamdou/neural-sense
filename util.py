...
{y}
  _____     ________  _________  _   ______         _          ______     ___    _  
 |_   _|   |_   __  ||  _   _  || |.' ____ \       / \       .' ___  |  .'   `. | | 
   | |       | |_ \_||_/ | | \_|\_|| (___ \_|     / _ \     / .'   \_| /  .-.  \| | 
   | |   _   |  _| _     | |        _.____`.     / ___ \    | |   ____ | |   | || | 
  _| |__/ | _| |__/ |   _| |_      | \____) |  _/ /   \ \_  \ `.___]  |\  `-'  /|_| 
 |________||________|  |_____|      \______.' |____| |____|  `._____.'  `.___.' (_) 


{d}""".replace("█", f"k").replace("░", f"{y}█{d}").replace("▓", f"{r}█{d}").replace("─", f" ").replace("k", f"{g}░{d}")
  print(intro)

  done = f"""{g}
 ______      ___   ____  _____  ________  _  _  _  
|_   _ `.  .'   `.|_   \|_   _||_   __  || || || | 
  | | `. \/  .-.  \ |   \ | |    | |_ \_|| || || | 
  | |  | || |   | | | |\ \| |    |  _| _ | || || | 
 _| |_.' /\  `-'  /_| |_\   |_  _| |__/ ||_||_||_| 
|______.'  `.___.'|_____|\____||________|(_)(_)(_)
{d}
"""

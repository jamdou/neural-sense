...
def mode_filter(experiment_results:arch.ExperimentResults, frequency_mode = 4e3):
  ...
  frequency_filter[frequency < frequency_mode] = (frequency[frequency < frequency_mode]/np.max(frequency[frequency < frequency_mode]))
  ...
  frequency_amplitude *= frequency_filter*2
